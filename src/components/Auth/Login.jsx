        ...
        <div className='flex h-screen w-screen items-center justify-center'>
            <div className='border-2 rounded-xl border-emerald-600 p-20'>
                <form
                    ...
                    <button className="text-white mt-7 border-none bg-emerald-300 hover:bg-emerald-700 font-semibold text-lg py-2 px-8 w-full rounded-full placeholder:text-white">Log in</button>
                </form>
            </div>
        </div>
    )
